...
extension float4x4 {
  ...
  public var formated: String {
    """
    *------------ float4x4 ------------*
    |\(self.format(columns.0, columns.0.x)), \(self.format(columns.1, columns.1.x)), \(self.format(columns.2, columns.2.x)), \(self.format(columns.3, columns.3.x))|
    |\(self.format(columns.0, columns.0.y)), \(self.format(columns.1, columns.1.y)), \(self.format(columns.2, columns.2.y)), \(self.format(columns.3, columns.3.y))|
    |\(self.format(columns.0, columns.0.z)), \(self.format(columns.1, columns.1.z)), \(self.format(columns.2, columns.2.z)), \(self.format(columns.3, columns.3.z))|
    |\(self.format(columns.0, columns.0.w)), \(self.format(columns.1, columns.1.w)), \(self.format(columns.2, columns.2.w)), \(self.format(columns.3, columns.3.w))|
    *----------------------------------*
    """
  }
}
